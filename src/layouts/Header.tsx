                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6">
                        ...
                        <div class="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                            ...
                            <div class="-mr-2 flex items-center md:hidden">
                                <button onClick={() => setVisible(true)} type="button" class="bg-gray-50 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-expanded="false">
                        ...
                        <div class="hidden md:flex md:space-x-10">
                            <a href="/about" class="font-medium text-gray-500 hover:text-gray-900">Product</a>
